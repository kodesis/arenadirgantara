            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user-menu">
                    <button class="dropdown-toggle nav-link" data-toggle="dropdown">
                        <img src="<?= base_url() ?>assets/dashboard/images/user/user-xs-01.jpg" class="user-image rounded-circle" alt="User Image" />
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        ...
                        <li class="dropdown-footer">
                            <a class="dropdown-link-item" href="<?= base_url('auth/logout') ?>"> <i class="mdi mdi-logout"></i> Log Out </a>
                        </li>
                    </ul>
                </li>
            </ul>
