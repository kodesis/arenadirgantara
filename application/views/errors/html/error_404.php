...
<head>
	...
	<title><?= isset($title) ? $title : '404 Not Found' ?> - Arena Dirgantara</title>
	<meta name="description" content="Arena Dirgantara">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="error-content">
							...
							<a href="<?= base_url() ?>" class="btn btn-two">Go Back To Home Page</a>
						</div>
					</div>
				</div>
			</div>
